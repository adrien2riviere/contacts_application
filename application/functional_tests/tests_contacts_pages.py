...
class Test0ContactsPages(LiveServerTestCase):
    ...
    # test de la bar de naivgation
    def test_01_navigation_bar(self):
    ...
    def test_02_contacts_page(self):
    ...
    def test_03_networks_page(self):
    ...
    def test_05_calendar_page(self):
